...
\frametitle{Rotação 3D}
	...
	\end{block}
		...
		\begin{figure}[!h]
			\begin{center}
    				\subfigure[]{
      				\includegraphics[width=0.2\textwidth]{Figures/PonRot}}\qquad
      			\subfigure[]{
      				\includegraphics[width=0.2\textwidth]{Figures/RotMovOri}}\qquad
      			\subfigure[]{
      				\includegraphics[width=0.2\textwidth]{Figures/Projyz}}\qquad
      			\subfigure[]{
      				\includegraphics[width=0.4\textwidth]{Figures/RotXZ}}\qquad
			\end{center}
		\end{figure}
